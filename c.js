async function getQueryAnswer(){
        try {
          const divRef = document.querySelector("#computer");
    ...
    "contents": [
      {
        "parts": [
            {
                text:"You are computer programmer and tell anything about computer , if other thing is asked said query is wrong",
